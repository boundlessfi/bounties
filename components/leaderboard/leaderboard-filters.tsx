...
export function LeaderboardFilters({
  ...
  const hasActiveFilters =
    filters.timeframe !== LeaderboardTimeframe.AllTime ||
    filters.tier ||
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 text-foreground">
      ...
      <Select
        ...
        onValueChange={(val) =>
          updateFilter("timeframe", val as LeaderboardTimeframe)
        }
      >
      ...
      <Select
        ...
        onValueChange={(val) =>
          updateFilter(
            "tier",
            val === "all" ? undefined : (val as ReputationTier),
          )
        }
      >
      ...
      <Popover>
        <PopoverTrigger asChild>
          <Button
            variant="outline"
            size="sm"
            className="h-10 border-border/50 border-dashed"
          >
